...
import com.example.echoshotx.application.video.usecase.GetMemberProcessedVideosUseCase;
...
public class VideoController {
    ...
    private final GetMemberProcessedVideosUseCase getMemberProcessedVideosUseCase;
    ...
    public ApiResponseDto<List<VideoListResponse>> getProcessedVideos(
        ...
        List<VideoListResponse> response = getMemberProcessedVideosUseCase.execute(member);
        return ApiResponseDto.onSuccess(response);
    }

package com.example.echoshotx.member.infrastructure.auth.service;
...
import com.example.echoshotx.member.infrastructure.auth.domain.CustomOAuthUser;
import com.example.echoshotx.member.infrastructure.auth.domain.OAuth2Attributes;
import com.example.echoshotx.member.infrastructure.auth.domain.SocialType;
import com.example.echoshotx.member.infrastructure.auth.dto.OAuth2UserInfo;
import com.example.echoshotx.member.infrastructure.auth.utils.OAuth2Utils;
